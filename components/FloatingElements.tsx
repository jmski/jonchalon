...
export default function FloatingElements() {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      ...
      {/* Bottom left accent */}
      <div className="absolute bottom-32 left-1/4 w-48 h-48 rounded-full blur-3xl animate-float-slower" style={{ background: 'linear-gradient(180deg, rgba(212, 165, 116, 0.1), transparent)' }}></div>

      {/* Bottom right accent */}
      <div className="absolute bottom-20 right-10 w-36 h-36 rounded-full blur-3xl animate-float-delayed" style={{ background: 'linear-gradient(225deg, rgba(249, 115, 22, 0.15), rgba(217, 119, 6, 0.1))' }}></div>
